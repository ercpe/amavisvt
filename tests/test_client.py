...
class TestClientReportToVT(object):
    ...
    @mock.patch(OPEN_PATCH)
    @mock.patch('amavisvt.client.requests.post')
    @pytest.mark.skipif(sys.version_info >= (3, 4, 0) and sys.version_info < (3, 5, 0),
                        reason="Test broken on python 3.4 (???)")
...
class TestClientRun(object):
    ...
    @mock.patch('amavisvt.client.memcache.Client.get')
    @mock.patch('amavisvt.client.Database')
    def test_run_with_unpack_and_cleanup(self, database_mock, memcached_get_mock, memcached_set_mock, requests_mock,
                                         avt):
    ...
    @mock.patch('amavisvt.client.memcache.Client.get')
    @mock.patch('amavisvt.client.Database')
    def test_run_with_directory(self, database_mock, memcached_get_mock, memcached_set_mock, requests_mock, tmpdir,
                                avt):
        memcached_get_mock.return_value = None
    ...
    @mock.patch('amavisvt.client.memcache.Client.get')
    @mock.patch('amavisvt.client.Database')
    def test_run_with_filename_pattern_detection_no_match(self, database_mock, memcached_get_mock, memcached_set_mock,
                                                          requests_mock):
        memcached_get_mock.return_value = None
    ...
    @mock.patch('amavisvt.client.memcache.Client.get')
    @mock.patch('amavisvt.client.Database')
    def test_run_with_filename_pattern_detection_match_with_autoreport(self, database_mock, memcached_get_mock,
                                                                       memcached_set_mock,
                                                                       requests_mock):
        memcached_get_mock.return_value = None
        database_mock.filename_pattern_match = mock.MagicMock()
